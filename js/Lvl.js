...
function createLvls(assets){
    ...
    for(let i = 1; i <41; i++) {
        ...
        let couleur = Math.floor(Math.random() * tabCouleurs.length);       
        lvl2.push(new Bricks(i, compteurX, compteurY, 96, 30, tabCouleurs[couleur], tabCouleursCassee[couleur],2));     
    ...
    for(let i = 1; i < 25; i++) { 
        ...
        let couleur = Math.floor(Math.random() * tabCouleurs.length);       
        lvl3.push(new Bricks(i, compteurX, compteurY, 96, 30, tabCouleurs[couleur], tabCouleursCassee[couleur],1));     
        compteurX = compteurX + 101
    }
    compteurX = 70;
    compteurY = 60;
