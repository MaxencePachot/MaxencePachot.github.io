...
function afficheMenuStart(ctx) {
    ...
    ctx.fillText("(S)tart", 280, 500);
    ctx.strokeText("(S)tart", 280, 500);
    ctx.fillText("(O)ptions", 600, 500);
    ctx.strokeText("(O)ptions", 600, 500);
    if(soundState == "off"){
...
function afficheGameOptions(ctx) {
    ...
    ctx.fillText("(E)chap", 200, 500);
    ctx.strokeText("(E)chap", 200, 500);
    ctx.font = "35px Arial";
